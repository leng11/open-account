 ...
 */
@ApiModel(description = "Dimensions Container. This container is not applicable for GFP Rating request.  Required for Heavy Goods service. Package Dimension will be ignored for Simple Rate")
@JsonPropertyOrder({
  PackageDimensions.JSON_PROPERTY_UNIT_OF_MEASUREMENT,
  PackageDimensions.JSON_PROPERTY_LENGTH,
  PackageDimensions.JSON_PROPERTY_WIDTH,
  PackageDimensions.JSON_PROPERTY_HEIGHT
})
@JsonTypeName("Package_Dimensions")
