 ...
 */
@ApiModel(description = "Address container for Alternate Delivery Address.")
@JsonPropertyOrder({
  AlternateDeliveryAddressAddress.JSON_PROPERTY_ADDRESS_LINE,
  AlternateDeliveryAddressAddress.JSON_PROPERTY_CITY,
  AlternateDeliveryAddressAddress.JSON_PROPERTY_STATE_PROVINCE_CODE,
  AlternateDeliveryAddressAddress.JSON_PROPERTY_POSTAL_CODE,
  AlternateDeliveryAddressAddress.JSON_PROPERTY_COUNTRY_CODE,
  AlternateDeliveryAddressAddress.JSON_PROPERTY_RESIDENTIAL_ADDRESS_INDICATOR,
  AlternateDeliveryAddressAddress.JSON_PROPERTY_PO_BOX_INDICATOR
})
@JsonTypeName("AlternateDeliveryAddress_Address")
...
public class AlternateDeliveryAddressAddress {
  ...
  public static final String JSON_PROPERTY_PO_BOX_INDICATOR = "POBoxIndicator";
  private String poBoxIndicator;

  public AlternateDeliveryAddressAddress() {
  }

  public AlternateDeliveryAddressAddress addressLine(String addressLine) {
  ...
  **/
  ...
  public AlternateDeliveryAddressAddress residentialAddressIndicator(String residentialAddressIndicator) {
  ...
  **/
  ...
  public AlternateDeliveryAddressAddress poBoxIndicator(String poBoxIndicator) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Presence/Absence Indicator. Any value inside is ignored. This field is a flag to indicate if the Alternate Delivery location is a PO box location.  True if POBoxIndicator tag exists; false otherwise.  Not valid with Shipment Indication Types: 01 Hold for Pickup at UPS Access Point 02 UPS Access Point� Delivery")
  @JsonProperty(JSON_PROPERTY_PO_BOX_INDICATOR)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressLine, alternateDeliveryAddressAddress.addressLine) &&
        ...
        Objects.equals(this.residentialAddressIndicator, alternateDeliveryAddressAddress.residentialAddressIndicator) &&
        Objects.equals(this.poBoxIndicator, alternateDeliveryAddressAddress.poBoxIndicator);
  }

  @Override
  public int hashCode() {
    return Objects.hash(addressLine, city, stateProvinceCode, postalCode, countryCode, residentialAddressIndicator, poBoxIndicator);
  }
  ...
  public String toString() {
    ...
    sb.append("    poBoxIndicator: ").append(toIndentedString(poBoxIndicator)).append("\n");
    sb.append("}");
    return sb.toString();
  }
