 ...
 */
@ApiModel(description = "TotalChargesWithTaxes container would be returned only if TaxInformationIndicator is present in request. TotalChargesWithTaxes contains total charges including total taxes applied to a shipment.")
@JsonPropertyOrder({
  NegotiatedRateChargesTotalChargesWithTaxes.JSON_PROPERTY_CURRENCY_CODE,
  NegotiatedRateChargesTotalChargesWithTaxes.JSON_PROPERTY_MONETARY_VALUE
})
@JsonTypeName("NegotiatedRateCharges_TotalChargesWithTaxes")
