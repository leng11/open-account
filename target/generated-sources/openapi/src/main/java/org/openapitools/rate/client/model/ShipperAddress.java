 ...
 */
@ApiModel(description = "Address Container.  If the ShipFrom container is not present then this address will be used as the ShipFrom. If this address is used as the ShipFrom, the shipment will be rated from this origin address.")
@JsonPropertyOrder({
  ShipperAddress.JSON_PROPERTY_ADDRESS_LINE,
  ShipperAddress.JSON_PROPERTY_CITY,
  ShipperAddress.JSON_PROPERTY_STATE_PROVINCE_CODE,
  ShipperAddress.JSON_PROPERTY_POSTAL_CODE,
  ShipperAddress.JSON_PROPERTY_COUNTRY_CODE
})
@JsonTypeName("Shipper_Address")
...
public class ShipperAddress {
  ...
  public ShipperAddress addressLine(String addressLine) {
