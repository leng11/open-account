 ...
 */
@ApiModel(description = "Container for additional information for the third party UPS accounts address.")
@JsonPropertyOrder({
  BillThirdPartyAddress.JSON_PROPERTY_POSTAL_CODE,
  BillThirdPartyAddress.JSON_PROPERTY_COUNTRY_CODE
})
@JsonTypeName("BillThirdParty_Address")
