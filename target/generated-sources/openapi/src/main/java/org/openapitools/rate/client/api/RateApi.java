...
@Component("org.openapitools.rate.client.api.RateApi")
public class RateApi {
     ...
     */
    public RATEResponseWrapper rate(String version, String requestoption, RATERequestWrapper raTERequestWrapper, String transId, String transactionSrc, String additionalinfo) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<RATEResponseWrapper> rateWithHttpInfo(String version, String requestoption, RATERequestWrapper raTERequestWrapper, String transId, String transactionSrc, String additionalinfo) throws RestClientException {
        ...
        ParameterizedTypeReference<RATEResponseWrapper> localReturnType = new ParameterizedTypeReference<RATEResponseWrapper>() {};
